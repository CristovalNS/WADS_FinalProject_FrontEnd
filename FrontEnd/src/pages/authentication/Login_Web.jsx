...
const Login = () => {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post('https://login-api-rho-one.vercel.app/login', {
        email,
        password,
      }, {
        headers: {
      ...
      // Fetch user data
      const userResponse = await axios.get(`https://login-api-rho-one.vercel.app/user/${uid}`);
